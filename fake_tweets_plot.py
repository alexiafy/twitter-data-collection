...
plt.bar(range(len(fake_tweets_dict)), list(fake_tweets_dict.values()), align='center', color=(0.2, 0.4, 0.6, 0.7))
...
plt.savefig("plots/fake_tweets.svg")
plt.show()
...
plt.savefig("plots/fake_replies.svg")
plt.show()
