'''
   Counts number of tweets and replies from trusted accounts. Only tweets
...
file = open("../results/RN - Number of tweets (only tweets with more than 20 replies).txt", "w")
total_count = 0
...
file = open("results/RN - Number of replies of tweets (only tweets with more than 20 replies).txt", "w")
replies_count = 0
for collection in collections:
    file.write("Account id: ")
    file.write(collection)
